import { Anchor, Col, PageHeader, Row, Tabs, Tag } from "antd";
...
export const DotInCircleIcon = (props) => (
  <Icon component={DotInCircleSVG} {...props} />
);
const { Link } = Anchor;
...
const Header = () => {
  ...
  const PullReqIcon = (props) => <Icon component={PullReqSVG} {...props} />;
  const ActionIcon = (props) => <Icon component={ActionSVG} {...props} />;
  const ProjectsIcon = (props) => <Icon component={PojectsSVG} {...props} />;
  const WikiIcon = (props) => <Icon component={WikiSVG} {...props} />;
  const SecurityIcon = (props) => <Icon component={SecuritySVG} {...props} />;
  const InsightsIcon = (props) => <Icon component={InsightsSVG} {...props} />;
    ...
    <PageHeader
      title={
        <Row>
          ...
          <Col>
            <Tag style={{ borderRadius: "10px" }}>Public</Tag>
          </Col>
        </Row>
      }
      extra={[
        <Tag key="1" icon={<EyeOutlined />} style={{ borderRadius: "10px" }}>
          Watch
        </Tag>,
        <Tag key="2" icon={<ForkOutlined />} style={{ borderRadius: "10px" }}>
          Fork
        </Tag>,
        <Tag key="3" icon={<StarOutlined />} style={{ borderRadius: "10px" }}>
          Star
        </Tag>,
      ]}
    >
      <Tabs defaultActiveKey="2" onChange={() => {}}>
        ...
        <TabPane
          tab={
            <>
              <PullReqIcon style={{ color: "hotpink" }} />
              Pull requests
            </>
          }
          key="3"
        ...
        <TabPane
          tab={
            <>
              <ActionIcon style={{ color: "hotpink" }} />
              Actions
            </>
          }
          key="4"
        ...
        <TabPane
          tab={
            <>
              <ProjectsIcon style={{ color: "hotpink" }} />
              Projects
            </>
          }
          key="5"
        ...
        <TabPane
          tab={
            <>
              <SecurityIcon style={{ color: "hotpink" }} />
              Security
            </>
          }
          key="7"
